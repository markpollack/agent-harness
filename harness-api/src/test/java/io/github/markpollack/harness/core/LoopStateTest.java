...
class LoopStateTest {
    ...
    class StuckDetection {
        ...
        void shouldDetectStuckWhenSameOutputRepeated() {
            ...
            LoopState state = LoopState.initial("test-run")
                    .completeTurn(100, 0.01, false, sameSignature)
                    .completeTurn(100, 0.01, false, sameSignature)
                    .completeTurn(100, 0.01, false, sameSignature);
        ...
        void shouldResetCountWhenOutputChanges() {
            LoopState state = LoopState.initial("test-run")
                    .completeTurn(100, 0.01, false, 111)
                    .completeTurn(100, 0.01, false, 111)
                    .completeTurn(100, 0.01, false, 222) // Different output
                    .completeTurn(100, 0.01, false, 333);
        ...
        void shouldCountCorrectlyWithInterleavedSameOutputs() {
            LoopState state = LoopState.initial("test-run")
                    .completeTurn(100, 0.01, false, 111)
                    .completeTurn(100, 0.01, false, 222)
                    .completeTurn(100, 0.01, false, 111) // Same as first, but not consecutive
                    .completeTurn(100, 0.01, false, 111);
